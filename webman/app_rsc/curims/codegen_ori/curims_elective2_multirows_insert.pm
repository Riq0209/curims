package curims_elective2_multirows_insert;
...
sub run_Task {
    ...
    if ($cgi->param("irn_curims_elective2") > 0) {
        $this->{row_num} = $cgi->param("irn_curims_elective2");
        
    } else {
        $cgi->push_Param("irn_curims_elective2", $this->{row_num});
    }    
