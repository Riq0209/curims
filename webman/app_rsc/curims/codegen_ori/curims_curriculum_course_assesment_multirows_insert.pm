package curims_curriculum_course_assesment_multirows_insert;
...
sub run_Task {
    ...
    if ($cgi->param("irn_curims_assesment") > 0) {
        $this->{row_num} = $cgi->param("irn_curims_assesment");
        
    } else {
        $cgi->push_Param("irn_curims_assesment", $this->{row_num});
    }    
