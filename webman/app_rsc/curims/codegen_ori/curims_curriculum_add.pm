...
sub run_Task {
    ...
    if ($submission_type eq "parent_list") {
        $cgi->push_Param("task", "curims_curriculum_list");        
...
sub customize_SQL {
    ...
    if (!$cgi->param_Exist("filter_curriculum_code_afls") || $cgi->param("filter_curriculum_code_afls") eq "") {
        $cgi->push_Param("filter_curriculum_code_afls", "\%");
    }
    my $filter_curriculum_code_afls = $cgi->param("filter_curriculum_code_afls");
    $sql_filter .= "curriculum_code like '$filter_curriculum_code_afls' and ";
    
    
    if (!$cgi->param_Exist("filter_curriculum_name_afls") || $cgi->param("filter_curriculum_name_afls") eq "") {
        $cgi->push_Param("filter_curriculum_name_afls", "\%");
    }
    my $filter_curriculum_name_afls = $cgi->param("filter_curriculum_name_afls");
    $sql_filter .= "curriculum_name like '$filter_curriculum_name_afls' and ";
