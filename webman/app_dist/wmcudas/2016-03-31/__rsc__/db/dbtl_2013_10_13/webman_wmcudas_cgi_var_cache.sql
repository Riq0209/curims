...
--
-- Table structure for table `webman_wmcudas_cgi_var_cache`
--

DROP TABLE IF EXISTS `webman_wmcudas_cgi_var_cache`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `webman_wmcudas_cgi_var_cache` (
...
) ENGINE=InnoDB AUTO_INCREMENT=37800 DEFAULT CHARSET=latin1;
