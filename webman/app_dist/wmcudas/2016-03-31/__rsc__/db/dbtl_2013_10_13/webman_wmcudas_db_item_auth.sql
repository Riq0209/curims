...
--
-- Table structure for table `webman_wmcudas_db_item_auth`
--

DROP TABLE IF EXISTS `webman_wmcudas_db_item_auth`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `webman_wmcudas_db_item_auth` (
...
--
-- Dumping data for table `webman_wmcudas_db_item_auth`
--

LOCK TABLES `webman_wmcudas_db_item_auth` WRITE;
/*!40000 ALTER TABLE `webman_wmcudas_db_item_auth` DISABLE KEYS */;
/*!40000 ALTER TABLE `webman_wmcudas_db_item_auth` ENABLE KEYS */;
UNLOCK TABLES;
