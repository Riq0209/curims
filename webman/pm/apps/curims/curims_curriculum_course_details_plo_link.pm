package curims_curriculum_course_details_plo_link;
...
sub customize_TLD {
    ...
    $tld->add_Column("curims_curriculum_details");
    ...
    for ($i = 0; $i < $tld->get_Row_Num; $i++) { 
        ...
        $dbu->set_Table("curims_curriculum_details");
        my $count_item = $dbu->count_Item("id_curriculum_62base", $tld->get_Data($i, "id_curriculum_62base"));
        $tld->set_Data($i, "curims_curriculum_details", $count_item);
