package curims_course_assesment_plo_link;
...
sub run_Task {
    ...
    if ($course_id) {
        ...
        $cgi->push_Param("course_curriculum_name_link", $label);
    }
...
sub customize_TLD {
    ...
    for ($i = 0; $i < $tld->get_Row_Num; $i++) { 
        ...
        $dbu->set_Table("curims_assesplo");
        my $count_item = $dbu->count_Item("id_assesment_62base", $tld->get_Data($i, "id_assesment_62base"));
