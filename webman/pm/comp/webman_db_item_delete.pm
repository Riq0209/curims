...
sub run_Task {
    ...
    ### try to auto set all possible data related CGI database cache variables
...
sub process_DATAHTML { ### so_type_ can be: VIEW, DYNAMIC, LIST, MENU, DBHTML, SELECT, DATAHTML
    ...
    ### 15/01/2012
    ### This below tasks might be no more required since we already have 
