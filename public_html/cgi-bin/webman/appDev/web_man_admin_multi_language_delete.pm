package web_man_admin_multi_language_delete;
...
sub process_Content {
    ...
    $this->set_Template_File("./template_admin_multi_language_delete.html");
...
sub process_DYNAMIC { ### so_type_ can be: VIEW, DYNAMIC, LIST, MENU, DBHTML, SELECT, DATAHTML
    ...
    my $hpd = $this->generate_Hidden_POST_Data("link_name_multi_lang dmisn_multi_lang link_name dmisn app_name lang_id");
...
sub process_DBHTML { ### so_type_ can be: VIEW, DYNAMIC, LIST, MENU, DBHTML, SELECT, DATAHTML
    ...
    $dbihtml->set_SQL("select * from $pre_table_name" . "dictionary_language where lang_id='$lang_id'");
