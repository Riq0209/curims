package web_man_admin_multi_language_add;
...
sub process_Content {
    ...
    $this->set_Template_File("./template_admin_multi_language_add.html");
...
sub process_DYNAMIC { ### so_type_ can be: VIEW, DYNAMIC, LIST, MENU, DBHTML, SELECT, DATAHTML
    ...
    my $hpd = $this->generate_Hidden_POST_Data("link_name_multi_lang dmisn_multi_lang link_name dmisn app_name");
